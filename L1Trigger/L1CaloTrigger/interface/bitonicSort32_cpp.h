#ifndef L1Trigger_L1CaloTrigger_bitonicSort32_cpp_h
#define L1Trigger_L1CaloTrigger_bitonicSort32_cpp_h
...
inline GreaterSmaller AscendDescend(ecalcluster &x, ecalcluster &y){
    GreaterSmaller s;
...
inline void FourinSmallFir(ecalcluster &x0, ecalcluster &x1, ecalcluster &x2, ecalcluster &x3,
...
inline void FourinGreatFir(ecalcluster &x0, ecalcluster &x1, ecalcluster &x2, ecalcluster &x3,
					ecalcluster &y0, ecalcluster &y1, ecalcluster &y2,ecalcluster &y3){
    GreaterSmaller res;
        res = AscendDescend(x0, x2);
...
inline void EightinSmallFir(ecalcluster &x0, ecalcluster &x1, ecalcluster &x2, ecalcluster &x3, ecalcluster &x4, ecalcluster &x5,
...
inline void EightinGreatFir(ecalcluster &x0, ecalcluster &x1, ecalcluster &x2, ecalcluster &x3, ecalcluster &x4, ecalcluster &x5,
                ecalcluster &x6, ecalcluster &x7, ecalcluster &y0, ecalcluster &y1,ecalcluster &y2, ecalcluster &y3, ecalcluster &y4, ecalcluster &y5, ecalcluster &y6, ecalcluster &y7){
        GreaterSmaller res;
        res = AscendDescend(x0, x4);
...
inline void SixteenSmallFir(ecalcluster &x0, ecalcluster &x1, ecalcluster &x2, ecalcluster &x3, ecalcluster &x4, ecalcluster &x5,
...
inline void SixteenGreatFir(ecalcluster &x0, ecalcluster &x1, ecalcluster &x2, ecalcluster &x3, ecalcluster &x4, ecalcluster &x5,
                    ecalcluster &x6, ecalcluster &x7, ecalcluster &x8, ecalcluster &x9, ecalcluster &x10, ecalcluster &x11, ecalcluster &x12, 
                     ecalcluster &x13, ecalcluster &x14, ecalcluster &x15,ecalcluster &y0,ecalcluster &y1,ecalcluster  &y2,ecalcluster &y3, ecalcluster &y4, ecalcluster &y5,ecalcluster &y6, 
                    ecalcluster &y7, ecalcluster &y8, ecalcluster &y9,ecalcluster &y10, ecalcluster &y11, ecalcluster &y12, ecalcluster &y13, ecalcluster &y14, ecalcluster &y15){
...
inline void bitonicSort32(ecalcluster in[N],ecalcluster out[N]){
